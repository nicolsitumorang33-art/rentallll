    ...
    <div class="pt-20 pb-20 px-6">
        <div class="w-full max-w-lg mx-auto mt-10">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-10 text-center">
                ...
                <p class="text-gray-500 text-sm mb-6">Booking #<?php echo e($booking->id); ?> telah dibatalkan.</p>
                <a href="<?php echo e(url('/')); ?>" class="inline-block bg-gray-800 text-white px-8 py-3 rounded-xl font-bold text-sm hover:bg-gray-700 transition">Kembali ke Beranda</a>
            </div>
            <?php else: ?>
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-10 text-center">
                ...
                <p class="text-gray-500 text-sm mb-6">Terima kasih, <strong><?php echo e($booking->customer_name); ?></strong>.</p>

                <div class="bg-gray-50 rounded-xl p-5 mb-6 text-left space-y-2 text-sm">
                    <div class="flex justify-between">
                        <span class="text-gray-500">Kode Booking</span>
                        <span class="font-bold text-red-600">#<?php echo e($booking->id); ?></span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-500">Mobil</span>
                        <span class="font-bold"><?php echo e($booking->car->name); ?></span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-500">Total</span>
                        <span class="font-bold text-red-600">Rp <?php echo e(number_format($booking->total, 0, ',', '.')); ?></span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-500">Status</span>
                        <span class="font-bold text-yellow-600 uppercase"><?php echo e($booking->status); ?></span>
                    </div>
                ...
                <div class="mt-6 pt-6 border-t border-gray-100">
                    <form method="POST" action="<?php echo e(route('booking.cancel', $booking->id)); ?>" onsubmit="return confirm('Yakin ingin membatalkan booking ini?')">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\Nicol-laravel\rentallll\resources\views/booking-success.blade.php ENDPATH**/ ?>