...
<body class="font-[Poppins] bg-gray-50" x-data="bookingForm()">
    ...
    <nav class="fixed top-0 left-0 right-0 z-50 bg-white shadow-sm border-t-4 border-[#8B0000]" x-data="{ open: false }">
        <div class="max-w-6xl mx-auto px-6 h-[70px] flex justify-between items-center">
            <a href="<?php echo e(url('/')); ?>" class="text-2xl font-extrabold text-red-600">RennMobil</a>
            <div class="hidden md:flex items-center gap-7">
                <a href="<?php echo e(url('/my-bookings')); ?>" style="color:#555;text-decoration:none;font-size:0.85rem;font-weight:500">Riwayat</a>
        ...
        <div x-show="open" @click.away="open = false" x-cloak class="md:hidden bg-white border-t shadow-lg px-6 py-4 space-y-3">
            <a href="<?php echo e(url('/my-bookings')); ?>" style="display:block;color:#555;text-decoration:none;font-size:0.9rem;font-weight:500">Riwayat</a>
    ...
    <div class="pb-20 px-6" style="padding-top: 30px;">
        <div class="w-full max-w-xl mx-auto px-4">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-10 text-center">
                ...
                <div class="bg-gray-50 rounded-xl p-5 mb-6 text-left space-y-2 text-sm">
                    <div class="flex justify-between">
                        ...
                        <span class="font-bold text-red-600">#<?php echo e($bookingSuccess->id); ?></span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-500">Mobil</span>
                        <span class="font-bold"><?php echo e($bookingSuccess->car->name); ?></span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-500">Total</span>
                        <span class="text-red-600 font-bold">Rp <?php echo e(number_format($bookingSuccess->total, 0, ',', '.')); ?></span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-500">Status</span>
                        <span class="font-bold text-yellow-600 uppercase"><?php echo e($bookingSuccess->status); ?></span>
                    </div>
                </div>
                <p class="text-xs text-gray-400 mb-6">Tim kami akan memeriksa pembayaran dan menghubungi Anda.</p>
                <div class="flex flex-col sm:flex-row gap-3 justify-center">
                    <a href="<?php echo e(url('/mobil')); ?>" class="bg-red-600 text-white px-6 py-3 rounded-xl font-semibold text-sm hover:bg-red-700 transition">Booking Lagi</a>
                    <a href="<?php echo e(url('/')); ?>" class="bg-gray-100 text-gray-700 px-6 py-3 rounded-xl font-semibold text-sm hover:bg-gray-200 transition">Kembali ke Beranda</a>
                </div>
                <?php if($bookingSuccess->status === 'pending'): ?>
                <div class="mt-6 pt-6 border-t border-gray-100">
                    <form method="POST" action="<?php echo e(route('booking.cancel', $bookingSuccess->id)); ?>" onsubmit="return confirm('Yakin ingin membatalkan booking ini?')">
                        <?php echo csrf_field(); ?>
            ...
            <?php else: ?>
            <form method="POST" action="<?php echo e(route('booking.store')); ?>" id="bookingForm" enctype="multipart/form-data" @submit.prevent="submitBooking()">
                <?php echo csrf_field(); ?>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    <div class="flex flex-col items-center text-center">
                        <div class="w-full max-w-[300px] h-40 flex items-center justify-center mb-4">
                            <img src="<?php echo e(asset('images/' . $car->image)); ?>" alt="<?php echo e($car->name); ?>" class="max-h-full max-w-full object-contain">
                        </div>
                        <h2 class="text-xl font-bold text-gray-800"><?php echo e($car->name); ?></h2>
                        ...
                        <div class="mt-4 flex gap-3 justify-center">
                            <span class="text-xs bg-gray-50 text-gray-600 px-3 py-1.5 rounded-full border border-gray-100"><i class="fas fa-users mr-1"></i> <?php echo e($car->seats); ?> Penumpang</span>
                            <span class="text-xs bg-gray-50 text-gray-600 px-3 py-1.5 rounded-full border border-gray-100"><i class="fas fa-gas-pump mr-1"></i> <?php echo e($car->transmission); ?></span>
                        </div>
                        <p class="text-red-600 font-bold text-xl mt-4">Rp <?php echo e(number_format($car->price, 0, ',', '.')); ?> <span class="text-sm font-normal text-gray-500">/ hari</span></p>
                    </div>
                </div>
                ...
                <div x-show="currentStep === 2" x-transition>
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-5">
                        ...
                        <div class="bg-gray-50 rounded-xl p-5 space-y-3 text-sm">
                            <div class="flex justify-between">
                                <span class="text-gray-500">Mobil</span>
                                <span class="font-bold"><?php echo e($car->name); ?></span>
                            </div>
                            <div class="flex justify-between">
    ...
    <footer class="bg-white border-t border-gray-100 py-8 text-center text-xs text-gray-400">
        <p>&copy; <?php echo e(date('Y')); ?> RennMobil Indonesia.</p>
    </footer>
    ...
    <script>
        function bookingForm() {
            return {
                ...
                withInsurance: false,
                days: 1,
                rentalPrice: <?php echo e($car->price); ?>,
                total: <?php echo e($car->price); ?>,
                fileSelected: null,
                proofFileName: '',
...
<?php /**PATH C:\xampp\htdocs\Nicol-laravel\rentallll\resources\views/booking.blade.php ENDPATH**/ ?>