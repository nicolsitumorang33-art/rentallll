                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
                        <div class="flex flex-col sm:flex-row gap-5">
                            <img src="<?php echo e(asset('images/car-avanza.jpg')); ?>" alt="Toyota Avanza" class="w-full sm:w-48 h-32 object-cover rounded-xl">
                            <div class="flex-1">
                    ...
                    <div x-show="currentStep === 4" x-transition>
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-10 text-center space-y-5">
                            ...
                            <div class="flex flex-col sm:flex-row gap-3 justify-center pt-4">
                                <a href="<?php echo e(url('/mobil')); ?>" class="bg-red-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-red-700 transition">Booking Lagi</a>
                                <a href="<?php echo e(url('/')); ?>" class="bg-gray-100 text-gray-700 px-6 py-3 rounded-xl font-semibold hover:bg-gray-200 transition">Kembali ke Beranda</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-24 space-y-4">
                        ...
                        <div class="bg-red-50 rounded-xl p-4 text-center">
                            ...
                            <a href="<?php echo e(url('/kontak')); ?>" class="text-red-600 font-semibold text-sm hover:underline">Hubungi Kami</a>
                        </div>
                    </div>
                </div>
            </div>
