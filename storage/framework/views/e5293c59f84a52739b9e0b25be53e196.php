        ...
        <div class="car-list-container">
            ...
            <div id="carList">
                ...
                <div class="car-card" data-name="<?php echo e(strtolower($car['name'])); ?>">
                    <img src="<?php echo e(asset('images/' . $car['image'])); ?>" alt="<?php echo e($car['name']); ?>" class="car-card-img">
                    <div class="car-card-info">
                        <h3><?php echo e($car['name']); ?></h3>
                        <p class="desc"><?php echo e($car['description']); ?></p>
                        <div class="car-specs">
                    ...
                    <div class="car-card-action">
                        <div class="car-price">Rp <?php echo e(number_format($car['price'], 0, ',', '.')); ?> <small>/Hari</small></div>
                        <a href="<?php echo e(url('/booking?car_id=' . $car['id'])); ?>" class="btn-order">
