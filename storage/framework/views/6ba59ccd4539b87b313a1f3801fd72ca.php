...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="navbar-links" id="navLinks">
            ...
            <li><a href="<?php echo e(url('/syarat')); ?>" class="active">S&K</a></li>
    ...
    <section class="section" style="padding-top:0">
        <div class="container">
            <div class="bantuan-card">
                ...
                <a href="<?php echo e(url('/kontak')); ?>" class="btn-bantuan">Hubungi Kami</a>
            </div>
        </div>
    </section>
...
</html><?php /**PATH C:\xampp\htdocs\Nicol-laravel\rentallll\resources\views/syarat.blade.php ENDPATH**/ ?>