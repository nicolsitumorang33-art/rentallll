                ...
                <?php if($errors->any()): ?>
                    <div class="error-message" style="flex-direction:column;align-items:flex-start;gap:4px">
                        <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span><i class="fas fa-exclamation-circle"></i> <?php echo e($error); ?></span>
                ...
                <form method="POST" action="<?php echo e(route('register.store')); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="name" placeholder="Masukkan nama lengkap" value="<?php echo e(old('name')); ?>" required autofocus>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\Nicol-laravel\rentallll\resources\views/register.blade.php ENDPATH**/ ?>