...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="navbar-links">
            ...
            <li><a href="<?php echo e(url('/my-bookings')); ?>" class="active">Riwayat</a></li>
            <li>
    ...
    <div class="container">
        ...
        <?php if(session('cancel_message')): ?>
        <div class="alert"><i class="fas fa-info-circle"></i> <?php echo e(session('cancel_message')); ?></div>
        <?php endif; ?>
        ...
        <div class="card">
            ...
            <div class="empty">
                ...
                <a href="<?php echo e(url('/mobil')); ?>">Booking Sekarang <i class="fas fa-arrow-right" style="font-size:0.7rem"></i></a>
            </div>
            <?php else: ?>
            <table>
                <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="font-weight:600;color:#333"><?php echo e($b->car->name ?? '-'); ?></div>
                            <div style="font-size:0.7rem;color:#999"><?php echo e($b->car->transmission ?? ''); ?> &middot; <?php echo e($b->car->seats ?? ''); ?> kursi</div>
                        </td>
                        <td>
                            <div><?php echo e(\Carbon\Carbon::parse($b->start_date)->format('d M Y')); ?></div>
                            <div style="font-size:0.7rem;color:#999">sd <?php echo e(\Carbon\Carbon::parse($b->end_date)->format('d M Y')); ?></div>
                        </td>
                        <td style="font-weight:600">Rp <?php echo e(number_format($b->total, 0, ',', '.')); ?></td>
                        <td>
                            <?php
                                $map = [
                            ...
                            ?>
                            <span class="badge <?php echo e($map[$b->status][0] ?? 'badge-pending'); ?>"><?php echo e($map[$b->status][1] ?? $b->status); ?></span>
                        </td>
                        <td><a href="<?php echo e(route('booking.success', $b->id)); ?>" class="btn-detail">Detail <i class="fas fa-chevron-right" style="font-size:0.6rem"></i></a></td>
                    </tr>
    ...
    <footer>&copy; <?php echo e(date('Y')); ?> RennMobil Indonesia.</footer>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\Nicol-laravel\rentallll\resources\views/my-bookings.blade.php ENDPATH**/ ?>