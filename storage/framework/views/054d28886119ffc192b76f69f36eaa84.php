...
<body>
    ...
    <section class="section" id="mobil">
        ...
        <div class="car-grid">
            <div class="car-card">
                <img src="<?php echo e(asset('images/car-avanza.jpg')); ?>" alt="Toyota Avanza" class="car-card-img">
                <div class="car-card-body">
                    <h3>Toyota Avanza</h3>
                    <p class="price">Rp 350.000 <small>/ hari</small></p>
                    <a href="<?php echo e(url('/booking')); ?>" class="btn-order">Pesan Sekarang</a>
                </div>
            </div>
            <div class="car-card">
                <img src="<?php echo e(asset('images/car-xpander.jpg')); ?>" alt="Mitsubishi Xpander" class="car-card-img">
                <div class="car-card-body">
            ...
            <div class="car-card">
                <img src="<?php echo e(asset('images/car-pajero.jpg')); ?>" alt="Mitsubishi Pajero Sport" class="car-card-img">
                <div class="car-card-body">
    ...
    <section class="section" id="galeri">
        ...
        <div class="galeri-grid">
            <div class="galeri-item">
                <img src="<?php echo e(asset('images/gallery-1.jpg')); ?>" alt="Galeri 1">
            </div>
            <div class="galeri-item">
                <img src="<?php echo e(asset('images/gallery-2.jpg')); ?>" alt="Galeri 2">
            </div>
            <div class="galeri-item">
                <img src="<?php echo e(asset('images/gallery-3.jpg')); ?>" alt="Galeri 3">
            </div>
            <div class="galeri-item">
                <img src="<?php echo e(asset('images/gallery-4.jpg')); ?>" alt="Galeri 4">
            </div>
            <div class="galeri-item">
                <img src="<?php echo e(asset('images/gallery-5.jpg')); ?>" alt="Galeri 5">
            </div>
            <div class="galeri-item">
                <img src="<?php echo e(asset('images/gallery-6.jpg')); ?>" alt="Galeri 6">
            </div>
            <div class="galeri-item">
                <img src="<?php echo e(asset('images/gallery-7.jpg')); ?>" alt="Galeri 7">
            </div>
            <div class="galeri-item">
                <img src="<?php echo e(asset('images/gallery-8.jpg')); ?>" alt="Galeri 8">
            </div>
        </div>
    </section>
    ...
    <footer class="footer">
        <div class="footer-grid">
            ...
            <div class="footer-col">
                <h4>Layanan</h4>
                <ul>
                    <li><a href="<?php echo e(url('/booking')); ?>">Sewa Mobil</a></li>
                    <li><a href="<?php echo e(url('/booking')); ?>">Sewa Sopir</a></li>
                    <li><a href="<?php echo e(url('/booking')); ?>">Rental Harian</a></li>
                    <li><a href="<?php echo e(url('/booking')); ?>">Rental Bulanan</a></li>
                </ul>
            </div>
...
<?php /**PATH C:\xampp\htdocs\Nicol-laravel\rentallll\resources\views/home.blade.php ENDPATH**/ ?>