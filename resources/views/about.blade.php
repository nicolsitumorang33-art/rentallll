...
<body>
    ...
    <section class="hero-about">
        <div class="hero-about-content">
            ...
            <div class="hero-about-img">
                <img src="{{ asset('images/about-car.jpg') }}" alt="RenMobil">
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="section-container">
            ...
            <div class="tim-grid">
                <div class="tim-card">
                    <img src="{{ asset('images/team-1.jpg') }}" alt="CEO" class="tim-img">
                    <div class="tim-info">
                        <h4>Ahmad Rizki</h4>
                ...
                <div class="tim-card">
                    <img src="{{ asset('images/team-2.jpg') }}" alt="COO" class="tim-img">
                    <div class="tim-info">
                ...
                <div class="tim-card">
                    <img src="{{ asset('images/team-3.jpg') }}" alt="CTO" class="tim-img">
                    <div class="tim-info">
                        <h4>Budi Santoso</h4>
                ...
                <div class="tim-card">
                    <img src="{{ asset('images/team-4.jpg') }}" alt="CMO" class="tim-img">
                    <div class="tim-info">
                        <h4>Dewi Lestari</h4>
