...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('admin.super') }}" class="sidebar-item {{ request()->routeIs('admin.super') ? 'active' : '' }}">
    ...
    <div class="main">
        ...
        <header class="topbar">
            <div class="topbar-left">
                ...
                <p>@yield('page-desc', 'Overview sistem')</p>
            </div>
            <div class="topbar-right">
                <div class="topbar-user">
                    ...
                    <div>
                        ...
                        <div class="topbar-role">{{ ucfirst(str_replace('_', ' ', auth()->user()->role)) }}</div>
                    </div>
                </div>
            </div>
        </header>
