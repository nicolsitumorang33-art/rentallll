...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="navbar-links" id="navLinks">
            ...
            <li><a href="{{ url('/kontak') }}" class="active">Kontak Kami</a></li>
            <li>
    ...
    <footer class="footer">
        <div class="footer-grid">
            ...
            <div class="footer-col">
                <h4>Layanan</h4>
                <ul>
                    <li><a href="{{ url('/layanan') }}">Sewa Lepas Kunci</a></li>
                    <li><a href="{{ url('/layanan') }}">Sewa Dengan Sopir</a></li>
                    <li><a href="{{ url('/layanan') }}">Paket Bulanan</a></li>
