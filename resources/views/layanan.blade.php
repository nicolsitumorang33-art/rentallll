...
<body class="font-[Poppins] bg-white">
    ...
    <nav class="fixed top-0 left-0 right-0 z-50 bg-white shadow-sm" x-data="{ open: false }">
        <div class="max-w-7xl mx-auto px-5 py-4 flex justify-between items-center">
            ...
            <div class="hidden md:flex items-center gap-7">
                ...
                <a href="{{ url('/layanan') }}" class="text-red-600 font-semibold relative after:absolute after:bottom-[-6px] after:left-0 after:w-full after:h-[3px] after:bg-red-600 after:rounded">Layanan</a>
        ...
        <div x-show="open" @click.away="open = false" x-cloak class="md:hidden bg-white border-t shadow-lg px-5 py-4 space-y-3">
            ...
            <a href="{{ url('/layanan') }}" class="block text-red-600 font-semibold">Layanan</a>
    ...
    <!-- HERO BANNER -->
    <section class="relative h-[400px] md:h-[500px] flex items-center bg-cover bg-center" style="background-image: url('{{ asset('images/hero-bg.jpg') }}')">
    ...
    <section class="pb-20 px-5">
        <div class="max-w-7xl mx-auto grid md:grid-cols-3 gap-6">
            ...
            <div class="group relative rounded-xl overflow-hidden shadow-sm hover:shadow-xl hover:scale-105 transition-all duration-300">
                <div class="h-[420px] bg-cover bg-center" style="background-image: url('{{ asset('images/layanan-1.jpg') }}')"></div>
                ...
                <div class="absolute inset-0 flex flex-col items-center justify-center px-6 text-center">
                    ...
                    <a href="{{ url('/booking') }}" class="bg-red-600 text-white px-6 py-2.5 rounded-full text-sm font-semibold hover:bg-red-700 transition">Selengkapnya</a>
                </div>
            </div>

            <!-- CARD 2: Sewa Mobil Dengan Sopir -->
            <div class="group relative rounded-xl overflow-hidden shadow-sm hover:shadow-xl hover:scale-105 transition-all duration-300">
                <div class="h-[420px] bg-cover bg-center" style="background-image: url('{{ asset('images/layanan-2.jpg') }}')"></div>
                ...
                <div class="absolute inset-0 flex flex-col items-center justify-center px-6 text-center">
                    ...
                    <a href="{{ url('/booking') }}" class="bg-white/90 text-gray-800 border border-gray-300 px-6 py-2.5 rounded-full text-sm font-semibold hover:bg-gray-100 hover:border-gray-400 transition">Selengkapnya</a>
                </div>
            </div>

            <!-- CARD 3: Sewa Mobil Bulanan & Harian -->
            <div class="group relative rounded-xl overflow-hidden shadow-sm hover:shadow-xl hover:scale-105 transition-all duration-300">
                <div class="h-[420px] bg-cover bg-center" style="background-image: url('{{ asset('images/layanan-3.jpg') }}')"></div>
